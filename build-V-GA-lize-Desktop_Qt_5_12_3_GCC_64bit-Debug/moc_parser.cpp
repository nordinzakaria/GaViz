...
#include "../V-GA-lize/models/parser.h"
...
QT_MOC_LITERAL(1, 7, 12), // "madeProgress"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 4) // "prog"

    },
    "Parser\0madeProgress\0\0prog"
};
...
void Parser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->madeProgress((*reinterpret_cast< float(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Parser::*)(float );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Parser::madeProgress)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Parser::madeProgress(float _t1)
{
