...
#include "../V-GA-lize/models/population.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Population_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Population_t qt_meta_stringdata_Population = {
    {
QT_MOC_LITERAL(0, 0, 10) // "Population"
...
QT_INIT_METAOBJECT const QMetaObject Population::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_Population.data,
    qt_meta_data_Population,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Population::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Population.stringdata0))
