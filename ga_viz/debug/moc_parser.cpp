...
#include "../sources/model/parser.h"
...
QT_MOC_LITERAL(3, 20, 7)
    ...
    "Parser\0doneParsing\0\0success\0"
};
...
void Parser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->doneParsing((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Parser::doneParsing)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Parser::doneParsing(bool _t1)
{
